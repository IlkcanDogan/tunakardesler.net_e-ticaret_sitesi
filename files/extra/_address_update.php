<?php  
	...
	if($requestMethod == "POST"){
		$addressId = $func->PostData("ADDRESS_ID");
		...
		if($name != ''){
			$db = new Database();
			if($db->CustomerUpdateAddress($addressId,$name,$surname,$phone,$addressName,$address,$cityId,$provinceId,$_SESSION["CUSTOMER_FIREBASE_ID"])) {
